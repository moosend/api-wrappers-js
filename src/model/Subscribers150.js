...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MoosendApi.Subscribers150 = factory(root.MoosendApi.ApiClient, root.MoosendApi.CustomField);
  }
  ...
  /**
   * The Subscribers150 model module.
   * @module model/Subscribers150
   * @version 1.0
   */

  /**
   * Constructs a new <code>Subscribers150</code>.
   * @alias module:model/Subscribers150
   * @class
   */
  ...
  /**
   * Constructs a <code>Subscribers150</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Subscribers150} obj Optional instance to populate.
   * @return {module:model/Subscribers150} The populated <code>Subscribers150</code> instance.
   */
