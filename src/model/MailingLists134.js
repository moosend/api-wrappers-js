...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MoosendApi.MailingLists134 = factory(root.MoosendApi.ApiClient, root.MoosendApi.MailingList69);
  }
  ...
  /**
   * The MailingLists134 model module.
   * @module model/MailingLists134
   * @version 1.0
   */

  /**
   * Constructs a new <code>MailingLists134</code>.
   * @alias module:model/MailingLists134
   * @class
   */
  ...
  /**
   * Constructs a <code>MailingLists134</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MailingLists134} obj Optional instance to populate.
   * @return {module:model/MailingLists134} The populated <code>MailingLists134</code> instance.
   */
