...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MoosendApi.UpdatingACustomFieldRequest = factory(root.MoosendApi.ApiClient);
  }
  ...
  /**
   * The UpdatingACustomFieldRequest model module.
   * @module model/UpdatingACustomFieldRequest
   * @version 1.0
   */

  /**
   * Constructs a new <code>UpdatingACustomFieldRequest</code>.
   * @alias module:model/UpdatingACustomFieldRequest
   * @class
  ...
  /**
   * Constructs a <code>UpdatingACustomFieldRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdatingACustomFieldRequest} obj Optional instance to populate.
   * @return {module:model/UpdatingACustomFieldRequest} The populated <code>UpdatingACustomFieldRequest</code> instance.
   */
