...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MoosendApi.CreatingADraftCampaignRequest = factory(root.MoosendApi.ApiClient, root.MoosendApi.MailingLists);
  }
  ...
  /**
   * The CreatingADraftCampaignRequest model module.
   * @module model/CreatingADraftCampaignRequest
   * @version 1.0
   */

  /**
   * Constructs a new <code>CreatingADraftCampaignRequest</code>.
   * @alias module:model/CreatingADraftCampaignRequest
   * @class
   * @param name {String} The name of the campaign.
   * @param subject {String} The subject line of the new campaign.
   * @param senderEmail {String} The sender email of the campaign.
   * @param replyToEmail {String} The email address to which recipients replies will arrive. It must be one of your sender accounts. If not specified, the sender's email will be assumed.
   * @param isAB {String} A flag that defines if a campaign is an AB campaign.
   */
  var exports = function(name, subject, senderEmail, replyToEmail, isAB) {
    var _this = this;

    _this['Name'] = name;
    _this['Subject'] = subject;
    _this['SenderEmail'] = senderEmail;
    _this['ReplyToEmail'] = replyToEmail;
    _this['IsAB'] = isAB;
  ...
  /**
   * Constructs a <code>CreatingADraftCampaignRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreatingADraftCampaignRequest} obj Optional instance to populate.
   * @return {module:model/CreatingADraftCampaignRequest} The populated <code>CreatingADraftCampaignRequest</code> instance.
   */
